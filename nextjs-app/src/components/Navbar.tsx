                ...
                {showProductsMenu && (
                    ...
                    >
                      <div className="grid grid-cols-2 gap-8">
                        <div>
                          <div className="text-[10px] font-black uppercase tracking-[0.28em] text-white/50 mb-4 px-2">Categorías</div>
                          <div className="space-y-1">
                            <Link 
                              href="/productos"
                              prefetch={true}
                              onClick={() => setShowProductsMenu(false)}
                              className="flex items-center justify-center w-full px-4 py-3 mb-4 rounded-lg bg-white text-black text-sm font-bold uppercase tracking-wider hover:bg-gray-200 transition-colors"
                            >
                            ...
                            {categorias.map((cat) => (
                              <div key={cat.id}>
                                <Link 
                                  ...
                                  prefetch={true}
                                  onClick={() => setShowProductsMenu(false)}
                                  className="flex items-center justify-between px-4 py-3 rounded-lg text-white/90 hover:bg-gray-800 text-sm font-medium uppercase tracking-wider group transition-colors"
                                >
                        ...
                        <div>
                          <div className="text-[10px] font-black uppercase tracking-[0.28em] text-white/50 mb-4 px-2">Filtros</div>
                          <div className="space-y-1">
